    ...
    public static void updateServerStatus(int msgType) {
        ...
        switch (msgType) {
            case SERVER_RUNNING:
                ...
                if (Server.isRunning()) {
                    if (Server.getViewersCount() != 0)
                        trayIcon.setImage(new ImageIcon(Rdesktopmain.ALIVE_ICON).getImage());
                    else
                        trayIcon.setImage(new ImageIcon(Rdesktopmain.WAIT_ICON).getImage());
                }
            ...
            case SERVER_NOT_RUNNING:
                ...
                trayIcon.setImage(new ImageIcon(Rdesktopmain.IDLE_ICON).getImage());
    ...
    public static void Show() {
        ...
        Runnable runner = new Runnable() {
            public void run() {
                ...
                trayIcon = new TrayIcon(new ImageIcon(Rdesktopmain.IDLE_ICON).getImage(),
                        "jrdesktop", popup);
