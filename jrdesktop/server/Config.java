...
public class Config {
    ...
    public static void loadConfiguration() {
        if (new File(Rdesktopmain.SERVER_CONFIG_FILE).canRead())
            try {
                Properties properties = new Properties();            
                properties.load(new FileInputStream(Rdesktopmain.SERVER_CONFIG_FILE));
    ...
    public static void storeConfiguration () {
        try {
            new File(Rdesktopmain.SERVER_CONFIG_FILE).createNewFile();        
            Properties properties = new Properties();
            ...
            properties.store(new FileOutputStream(Rdesktopmain.SERVER_CONFIG_FILE), 
